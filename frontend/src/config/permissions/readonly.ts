...
const readonly: Record<LfPermission, boolean> = {
  ...
  [LfPermission.reportImport]: false,
  [LfPermission.reportCreate]: false,
  [LfPermission.reportEdit]: false,
  [LfPermission.reportDestroy]: false,
  [LfPermission.reportRead]: true,
  [LfPermission.reportAutocomplete]: false,
  ...
  [LfPermission.eagleEyeContentRead]: true,
  [LfPermission.eagleEyeContentCreate]: false,
  [LfPermission.eagleEyeContentEdit]: false,
  ...
  [LfPermission.noteCreate]: false,
  [LfPermission.noteEdit]: false,
  [LfPermission.noteDestroy]: false,
