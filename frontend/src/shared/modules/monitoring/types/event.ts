...
export enum PageEventKey {
  ...
  CONTRIBUTORS_MERGE_SUGGESTIONS = 'Contributors merge suggestions',
...
export enum FeatureEventKey {
  ...
  MERGE_CONTRIBUTOR = 'Merge contributor',
  MARK_AS_TEAM_CONTRIBUTOR = 'Mark as team contributor',
  MARK_AS_BOT = 'Mark as bot',
  DELETE_CONTRIBUTOR = 'Delete contributor',
  EXPORT_CONTRIBUTORS = 'Export contributors',
  EDIT_CONTRIBUTOR_TAGS = 'Edit contributor tags',
  EDIT_CONTRIBUTOR_ATTRIBUTES = 'Edit contributor attributes',
  FILTER_CONTRIBUTORS = 'Filter contributors',
  ...
  SORT_CONTRIBUTORS = 'Sort contributors',
  ...
  EDIT_CONTRIBUTOR_IDENTITY = 'Edit contributor identity',
  EDIT_CONTRIBUTOR_EMAIL = 'Edit contributor email',
  ...
  UNMERGE_CONTRIBUTOR_IDENTITY = 'Unmerge contributor identity',
  ADD_NOTE = 'Add note',
  EDIT_NOTE = 'Edit note',
  ...
  FILTER_CONTRIBUTORS_MERGE_SUGGESTIONS = 'Filter contributors merge suggestions',
  SEARCH_CONTRIBUTORS_MERGE_SUGGESTIONS = 'Search contributors merge suggestions',
  SORT_CONTRIBUTORS_MERGE_SUGGESTIONS = 'Sort contributors merge suggestions',
  ...
  VIEW_CONTRIBUTOR_MERGE_SUGGESTION = 'View contributor merge suggestion',
  NAVIGATE_CONTRIBUTORS_MERGE_SUGGESTIONS = 'Navigate contributors merge suggestions',
  IGNORE_CONTRIBUTOR_MERGE_SUGGESTION = 'Ignore contributor merge suggestion',
  ...
  MERGE_CONTRIBUTOR_MERGE_SUGGESTION = 'Merge contributor merge suggestion',
