<template>
  <app-dialog v-model="model" custom-class="remove-confirm-dialog" @close="onClose">
    <template #content>
      <div class="flex flex-col">
        <!-- Header -->
        <section class="p-6 flex">
          <span class="rounded-full bg-red-100 w-10 h-10 mr-4 flex items-center justify-center">
        ...
        <section class="p-6 pt-0 ml-14">
          ...
          <lf-input v-model="removeConfirm" :placeholder="`Type ${confirmText.toUpperCase()} to confirm`" />
        </section>
        <!-- Footer -->
