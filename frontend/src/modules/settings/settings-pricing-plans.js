...
export const plans = {
  crowdHosted: [
    ...
    },
    {
      ...
      features: [
        'Eagle Eye',
        '1,000 contributor enrichments per month (manual)',
    ...
    },
    {
      ...
      features: [
        ...
        'Unlimited contributor & organization enrichment (automated)',
  ...
  community: [
    {
      ...
      features: [
        'Unlimited seats',
        'Unlimited community contributors & activities',
        'Community management',
        'Community intelligence',
    ...
    },
    {
      ...
      features: [
        ...
        'LinkedIn integration',
        'Unlimited contributor enrichments (automated)',
      ],
    },
  ],
};
