...
export const plans = {
  crowdHosted: [
    ...
    },
    {
      ...
      features: [
        'Eagle Eye',
        '1,000 contact enrichments per month (manual)',
    ...
    },
    {
      ...
      features: [
        ...
        'Unlimited contact & organization enrichment (automated)',
  ...
  community: [
    {
      ...
      features: [
        'Unlimited seats',
        'Unlimited community contact & activities',
        'Community management',
        'Community intelligence',
