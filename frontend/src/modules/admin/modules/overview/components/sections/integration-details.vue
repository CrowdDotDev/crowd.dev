...
const { data, isError, isPending, isFetchingNextPage, fetchNextPage, hasNextPage } = OVERVIEW_API_SERVICE.fetchGlobalIntegrations(params);
...
const isEmpty = computed(() => {
  return overviewTabs.value.every(tab => tab.count === 0);
});
