export const pageContent = {
  eagleEye: {
    ...
    featuresList: [
      {
        icon: 'eye',
        title: 'Keep an Eagle Eye view on relevant content & posts to grow',
        content:
      ...
      {
        icon: 'grid-round-2',
        title: 'Identify and engage with content across platforms',
        content:
      ...
      },
      {
        ...
        title: 'Search powered by Natural Language Processing',
        content:
