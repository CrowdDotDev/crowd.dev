<template>
  <div>
    <el-tooltip
      ...
      content="Please enable Person syncing in HubSpot integration settings to use this feature"
      placement="bottom"
    >
      <el-checkbox
      ...
      >
        <span class="text-xs" :class="canSyncMembers ? 'text-gray-900' : 'text-gray-400'">
          Sync all people from the organisations matching your conditions criteria
        </span>
      </el-checkbox>
    </el-tooltip>
