<template>
  <article>
    <p class="text-xs font-semibold leading-5 mb-3">
      Deleted contacts visibility
    </p>
    <el-radio-group v-model="value">
      <el-radio :label="IncludeEnum.EXCLUDE" class="!h-5">
        <span class="text-xs">Exclude deleted contacts</span>
      </el-radio>
      <el-radio :label="IncludeEnum.INCLUDE" class="!h-5">
        <span class="text-xs">Include deleted contacts</span>
      </el-radio>
      <el-radio :label="IncludeEnum.FILTER" class="!h-5">
        <span class="text-xs">Deleted contacts only</span>
      </el-radio>
    </el-radio-group>
  </article>
</template>
