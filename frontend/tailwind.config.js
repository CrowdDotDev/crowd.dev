...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      tt: ['var(--lf-text-tiny-font-size)', 'var(--lf-text-tiny-line-height)'],
      ts: ['var(--lf-text-small-font-size)', 'var(--lf-text-small-line-height)'],
      tm: ['var(--lf-text-medium-font-size)', 'var(--lf-text-medium-line-height)'],
      tl: ['var(--lf-text-large-font-size)', 'var(--lf-text-large-line-height)'],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
