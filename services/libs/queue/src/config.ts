...
export const NODEJS_WORKER_QUEUE_SETTINGS = {
  [QueueVendor.KAFKA]: KafkaQueueConfig.NODEJS_WORKER_QUEUE_SETTINGS,
  [QueueVendor.SQS]: SqsQueueConfig.NODEJS_WORKER_QUEUE_SETTINGS,
}

export const INTEGRATION_SYNC_WORKER_QUEUE_SETTINGS = {
  [QueueVendor.KAFKA]: KafkaQueueConfig.INTEGRATION_SYNC_WORKER_QUEUE_SETTINGS,
  [QueueVendor.SQS]: SqsQueueConfig.INTEGRATION_SYNC_WORKER_QUEUE_SETTINGS,
}
