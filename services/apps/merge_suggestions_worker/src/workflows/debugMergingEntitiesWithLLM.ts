...
import { ILLMResult, IProcessDebugSimilarityWithLLM } from '../types'
...
export async function debugMergingEntitiesWithLLM(
  args: IProcessDebugSimilarityWithLLM,
): Promise<void> {
  ...
  const suggestions = args.organizationCouples
