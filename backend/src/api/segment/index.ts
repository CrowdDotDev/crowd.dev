...
export default (app) => {
    ...
    app.post(`/tenant/:tenantId/segment/projectGroup/query`, safeWrap(require('./segmentProjectGroupQuery').default))
    
    // query all projects
    app.post(`/tenant/:tenantId/segment/project/query`, safeWrap(require('./segmentProjectQuery').default))

    // query all subprojects
    app.post(`/tenant/:tenantId/segment/subproject/query`, safeWrap(require('./segmentSubprojectQuery').default))
