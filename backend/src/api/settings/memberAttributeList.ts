 ...
 * @summary List member attribute's settings
 * @tag Member Attributes
 * @security Bearer
 * @description Get a list of member attribute's settings with filtering, sorting and offsetting.
 * @pathParam {string} tenantId - Your workspace/tenant ID
 * @queryParam {string} [filter[type]] - Filter by type of member attribute settings.
 * @queryParam {string} [filter[canDelete]] - Filter by canDelete of member attribute settings.
 * @queryParam {string} [filter[show]] - Filter by show of member attribute settings.
