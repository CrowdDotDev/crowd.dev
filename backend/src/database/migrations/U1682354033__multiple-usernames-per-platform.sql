...
with identities as (select mi."memberId",
                           ...
                           jsonb_object_agg(mi.platform, mi.latest_username) as username,
                           jsonb_object_agg(mi.platform, mi.usernames)       as "newUsername"
                    from (select "memberId",
                                 platform,
                                 max(username) filter (where is_latest) as latest_username,
