      ...
      expect(prsParsed.activities).toStrictEqual([
        {
          ...
          member: ghi.parseMember(singlePr.author),
    ...
    expect(issuesParsed.activities).toStrictEqual([
      {
        ...
        member: ghi.parseMember(singleIssue.author),
    ...
    expect(discussionsParsed.activities).toStrictEqual([
      {
        ...
        member: ghi.parseMember(singleDiscussion.author),
    ...
    const expectedParsedOutput = [
      {
        ...
        member: ghi.parseMember(singleDiscussionComment.author),
