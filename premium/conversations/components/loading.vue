<template>
  <div
    v-show="!hideLoading"
    class="h-screen w-screen bg-background flex items-center justify-center"
...
export default defineComponent({
  setup() {
    ...
    const hideLoading = computed(() => {
      return isLoaded.value.conversations && isLoaded.value.mode
    })
  ...
  methods: {
    colors(picks) {
      if (!this.styles) {
        ...
        console.log("loading: styles from state")
      }
